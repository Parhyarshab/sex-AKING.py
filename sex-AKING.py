...
def readline___Public_Xml():
	...
	print (' [*]=============================================')
	print(" [1] START CRACK  ")
	print(" [2] CREATE FILE [ UNLIMITED ]")
	print(" [3] FEEDBACK")
	print(" [4] YOUTUBE ")
	print (" [5] LOGIN ANOTHER TOKEN")
	print (" [0] EXIT")
	print (' [*]=============================================')
	key = input(" [*] input : ")
	print (' [*]=============================================')
...
def hasil(ok,cp):
	if len(ok) != 0 or len(cp) != 0:
		IMTIAZ_AKING('\n\n\033[0m THE PROCESS HAS BEEN STARTED')
		IMTIAZ_AKING('\n\033[1;92mTOTAL SK OK : %s •  TOTAL SK CP : %s'%(str(len(ok)),str(len(cp))));exit()
...
banner="""\033[1;37m
.d8888. db   db  .d8b.  db   d8b   db 
88'  YP 88   88 d8' `8b 88   I8I   88 
`8bo.   88ooo88 88ooo88 88   I8I   88 
  `Y8b. 88~~~88 88~~~88 Y8   I8I   88 
db   8D 88   88 88   88 `8b d8'8b d8' 
`8888Y' YP   YP YP   YP  `8b8' `8d8'  
